...
export default function Edit({ item, categories, locations, users }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        accountable_person_id: item.accountable_person?.id.toString() || '',
        accountable_person_name: item.accountable_person_name || '',
        accountable_person_position: item.accountable_person_position || '',
        date_acquired: item.date_acquired,
        date_inventoried: item.date_inventoried || '',
    ...
    return (
        ...
        >
            <Head title={`Edit Item - ${item.property_number}`} />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Update item information for {item.property_number}
                        </p>
                    </div>
                </div>
